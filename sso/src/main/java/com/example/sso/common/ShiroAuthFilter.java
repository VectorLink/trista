...
import com.example.sso.common.service.CglibProxy;
import com.example.sso.service.impl.AuthServiceImpl;
...
@Component
@Slf4j
public abstract class ShiroAuthFilter implements Filter{
    @Autowired
